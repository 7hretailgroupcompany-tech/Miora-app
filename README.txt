...
FIX APPLIED:
- Fixed Express 5 catch-all route in server.js. Express 5 does not allow app.get('*', ...); this project now uses app.get('/{*splat}', ...).
- package.json now declares Node.js 18+ because the backend uses the built-in fetch API.
